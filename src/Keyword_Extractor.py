...
class Extractor:
    ...
    def __init__(self, job_desc, resume):
        """
    ...
    def sendCumlatives(self):
        ...
        for type in ['hard', 'soft', 'general']:
            ...
            if type == 'hard':
                ...
                measur2 = self.measure3(v1, v2)
            else:
                measur3 = self.measure3(v1, v2)
        return measur1, measur2, measur3
